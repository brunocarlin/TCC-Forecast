...
Temp2 <- lapply(Temp, `[[`,2)
Temp3 <- lapply(Temp2, `[[`, 1)
Temp4 <- lapply(Temp3, `[[`, 4)
Temp5 <- lapply(Temp4, `[[`, 4)

Results <- as.tibble(melt(Temp4))
...
colnames(Results) <- c("OS_Error_Type","Forecast_Horizon","Resultss","In_Sample_Error","Error_Type","Dont_Know")  
...
save(SomethingTeste2,file = "Results_K_Folds_M4_4_Methods.RData")
